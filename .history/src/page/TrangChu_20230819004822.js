        ...
        <div className="pt-[90px] pl-[270px]">
            <div className="flex flex-row">
                ...
                <div className="flex flex-row gap-10 pl-[30px] ">
                    <div className="w-[300px] h-[200px] bg-white shadow-2xl rounded-[20px] ">
                        <p className="text-[20px] font-bold pt-5 pl-7">Khoá học</p>
                        <div className="flex flex-row gap-[100px] pt-10">
                            <p className="font-bold items-center pl-7 ">00/50</p>
                            <p className="font-bold text-[13px]">0 chứng nhận</p>
                        </div>
                        <div className="pt-2 pl-7">
                            <div className="h-3 w-[200px] bg-amber-300 rounded-[10px]"></div>
                        </div>
                    </div>
                </div>
            </div>
