...
const TrangChu = () => {
    return (
        <div className="pt-[90px] pl-[270px]">
            ...
            <div className="pt-10">
                <div className="flex flex-row">
                    <p className="text-[25px] font-black ">Thi JLPT</p>
                    <p className=" pl-[900px] text-sky-500">Tất cả</p>
                    <MdKeyboardArrowRight className="h-[25px] w-[25px] text-sky-500"/>
                </div>
                <div className="flex flex-row gap-5 pt-5 items-center">
                    ...
                    <div className="w-[250px] h-[350px] bg-sky-500 rounded-[20px] py-5 px-5">
                        <div className="">
                            <img 
                                className=" rounded-[20px]  "
                                src = {photo4}
            ...
            <div className="pt-10">
                <div className="flex flex-row">
                    <p className="text-[25px] font-black ">Bài viết</p>
                    <p className=" pl-[900px] text-sky-500">Tất cả</p>
                    <MdKeyboardArrowRight className="h-[25px] w-[25px] text-sky-500"/>
                </div>
                <div className="flex flex-row gap-5 pt-5 items-center">
            ...
            <div className="pt-10">
                <div className="flex flex-row">
                    <p className="text-[25px] font-black ">Hoat hình</p>
                    <p className=" pl-[900px] text-sky-500">Tất cả</p>
                    <MdKeyboardArrowRight className="h-[25px] w-[25px] text-sky-500"/>
                </div>
                <div className="flex flex-row gap-5 pt-5 items-center">
                ...
                <div className="flex flex-row gap-2 items-center pt-5 pl-[550px] pb-5">
                    <div className="h-[10px] w-[10px] rounded-full bg-black/30"></div>
                    <div className="h-[10px] w-[10px] rounded-full bg-black"></div>
                    <div className="h-[10px] w-[10px] rounded-full bg-black/30"></div>
                    <div className="h-[10px] w-[10px] rounded-full bg-black/30"></div>
