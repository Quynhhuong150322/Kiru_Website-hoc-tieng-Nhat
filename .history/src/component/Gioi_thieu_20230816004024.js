...
không giới hạn </p>
            ...
            <div 
                ...
                <div className="backdrop-sepia-0 bg-white/80 h-[450px] ">
                    <div className="pl-[100px] w-[700px]">
                        <div className="pt-[100px] font-inter font-bold text-[25px]">Bạn chưa biết <p className="text-[30px]">bắt đầu từ đâu</p> và phải học như thế nào?</div> 
