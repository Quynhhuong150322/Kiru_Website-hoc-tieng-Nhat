...
không giới hạn </p>
            ...
            <div 
                ...
                <div className="backdrop-sepia-0 bg-white/80 h-[450px] ">
                    <div className="pl-[130px] w-[680px]">
                        <div className="pt-[70px] font-inter font-bold text-[36px] text-blue-500">Bạn chưa biết <a class="text-[50px]">bắt đầu từ đâu</a> và phải học như thế nào?</div> 
