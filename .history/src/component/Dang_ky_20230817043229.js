                ...
                <div className=" pr-[100px]">
                    <div className="w-[650px] h-[650px] bg-amber-300 rounded-[20px]">
                        ...
                        <div className="pt-7">
                            <button 
                                type="button"
                                className = "w-[200px] h-[70px] rounded-[40px] text-white bg-gradient-to-r from-amber-300  to-orange-500 hover:border-2 border-amber-700 hover:text-sky-500 font-interBold text-[25px] items-center">
                                Tham gia ngay
                            </button>
                        </div>
                    </div>
