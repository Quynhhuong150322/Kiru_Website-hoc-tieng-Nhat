            ...
            <div className="h-[800px] flex justify-between pt-7">
                ...
                <div className=" pr-[100px]">
                    <div className="w-[650px] h-[650px] bg-amber-300 rounded-[20px]">
                        ...
                        <div className="pt-7  pl-[230px]">
                            <button 
                                type="button"
                                className = " text-center w-[150px] h-[40px] rounded-[40px] text-white  bg-blue-500  font-interBold text-[20px] ">
                                Đăng ký
                            </button>
                        </div>
                        <div className="flex flex-row gap-4 items-center pt-7 pl-[150px]">
                            <div className="w-[100px] h-[1px] bg-black"></div>
                            <p className="pl-2 text-[14px] text-center">hoặc</p>
                            <div className="w-[100px] h-[1px] bg-black"></div>
                        </div>
                    </div>
                </div>
