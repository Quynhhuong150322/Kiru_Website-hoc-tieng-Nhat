            ...
            <div className="pb-[100px]">
                ...
                <div className=" grid grid-cols-2 gap-[500px]">
                    <div className="pl-[200px] grid grid-cols-2 gap-10 flex-initial w-[1000px] pt-5">
                        ...
                        <div className="">
                            <div className="flex items-center gap-[20px]">
                                <div className="h-[50px] flex-initial w-[50px] bg-pink-500 rounded-[10px] text-[40px] font-[600] cursor-pointer items-center text-center ">
                                    <GiGraduateCap className="fill-white pt-2"/>
                                </div>
