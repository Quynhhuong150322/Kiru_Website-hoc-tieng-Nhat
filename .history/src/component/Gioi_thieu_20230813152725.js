        ...
        <div class="">
            <div
                ...
                <div className="pl-[200px]">
                    ...
                    <div className="font-inter font-bold text-xl pt-[50px] text-slate-400">Website học tiếng Nhật tuyến Kiru hoàn toàn miễn phí tích hợp đầy đủ các kiến thức, kỹ năng thông qua các video bài giảng và bài tập giúp các bạn dễ dàng chinh phục tiếng Nhật một cách dễ dàng.</div>
                    <div className="pt-10">
                        <button 
                            type="button"
