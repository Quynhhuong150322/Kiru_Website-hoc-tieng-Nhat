            ...
            <div className = "bg-white top-0 h-[100px] pt-5">
                <div class="flex justify-between items-center p-1">
                    ...
                    <div className="pt-10">
                        <button 
                            type="button"
                            className = "w-[100px] h-[30px] rounded-[40px] text-white bg-gradient-to-r from-amber-300  to-orange-500 hover:border-2 border-amber-700 hover:text-sky-500 font-interBold text-[20px] items-center">
                            Trợ giúp
                        </button>
                    </div>
                </div>
