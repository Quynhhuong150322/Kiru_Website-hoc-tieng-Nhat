        ...
        <div class="">
            <div className="h-[350px] bg-sky-950 flex justify-between items-center p-1">
                ...
                <div className="">
                    ...
                    <div className="h-[70px] w-[200px] bg-white rounded-[20px] grid grid-cols-2 gap-1 items-center">
                    ...
                    <div className="h-[70px] w-[200px] bg-white rounded-[20px] grid grid-cols-2 gap-[10px]">
                        <FaGooglePlay className="w-[45px] h-[45px]"/>
                        <div className="">
                            Tải về từ <p className="">App Store</p>
                        </div>
                    </div>
