...
import {FaApple, FaGooglePlay, FaYoutube,  FaFacebookF, FaInstagram} from "react-icons/fa";

const Footer = () => {
    return (
        <div class="h-[350px] bg-sky-950">
            <div className=" flex justify-between pt-[30px] px-[60px]">
                <div className="flex-initial w-[300px]">
                    ...
                    <div class="flex flex-row gap-5 pt-5">
                        ...
                        <div className="w-8 h-8 bg-slate-600 rounded-full">
                            <FaFacebookF className="text-white w-7 h-7 px-1 pt-2"/>
                        </div>
                        <div className="w-8 h-8 bg-slate-600 rounded-full">
                            <FaInstagram className="text-white w-7 h-7 px-1 pt-1"/>
                        </div>
                    </div>
                </div>
