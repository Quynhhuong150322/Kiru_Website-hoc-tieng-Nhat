            ...
            <div className=" flex justify-between pt-[50px] px-[60px]">
                <div className="flex-initial w-[300px]">
                    <img 
                        ...
                        alt = "logo" 
                    />
                    <p className="text-white"> <a className="font-bold font-japanese">Kiru</a> là Website học tiếng Nhật <p> hiệu quả nhất phù hợp với mọi người.</p> <p className="">by @QuynhHuong</p></p>
                </div>
