...
import {FaApple, FaGooglePlay, FaYoutube,  FaFacebook, FaInstagramSquare} from "react-icons/fa";
            ...
            <div className=" flex justify-between pt-[50px] px-[60px]">
                <div className="flex-initial w-[300px]">
                    ...
                    <div class="flex flex-row gap-5">
                        ...
                        <FaInstagramSquare className="text-white w-7 h-7 "></FaInstagramSquare>
                    </div>
                </div>
