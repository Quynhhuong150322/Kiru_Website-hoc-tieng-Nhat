            ...
            <div className="h-[350px] bg-sky-950 flex justify-between pt-[50px] px-[60px]">
                ...
                <div className="flex flex-row gap-[100px]">
                    <ul class="list-none text-white">
                        ...
                        <li className="hover:text-yellow-500 ">Khóa học </li>
                        <li className="hover:text-yellow-500 ">Ôn tập </li>
                        <li className="hover:text-yellow-500 ">Thi thử JLPT</li>
                        <li className="hover:text-yellow-500 ">Blog</li>
                        <li className="hover:text-yellow-500 ">Anime</li>
                    </ul>
                    <ul class="list-none text-white">
