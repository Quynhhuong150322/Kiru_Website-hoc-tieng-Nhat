...
không giới hạn </p>
            ...
            <div 
                className="bg-[url('/Users/quynhhuong/kiru_web/src/image/photo3.jpeg')] bg-cover bg-center h-[450px] backdrop-sepia-50 bg-white/30"
                alt = "photo3" >
                <div className="backdrop-sepia-50 bg-white/60 h-[400px] ">
