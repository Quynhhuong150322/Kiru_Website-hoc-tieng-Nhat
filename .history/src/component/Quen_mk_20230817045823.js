            ...
            <div className="h-[800px] flex justify-between pt-7">
                ...
                <div className=" pr-[100px] pt-10">
                    <div className="w-[650px] h-[400px] bg-amber-300 rounded-[20px]">
                        <p className="text-center font-interBold text-[28px] pt-4">Quên mật khẩu</p>
                        <p className="text-center font-inter text-[16px]">Quay lại <a className="text-blue-600 font-bold">Đăng nhập</a> </p>
                        <p className="pt-10 text-center font-inter text-[16px]">Nhập email hoặc số điện thoại của bạn để <p>nhận mã xác nhận để lấy lại mật khẩu.</p></p>
                        ...
                        <p className="text-center text-[14px] pt-5">Quay lại</p>
                    </div>
                </div>
            </div>
        </div>
