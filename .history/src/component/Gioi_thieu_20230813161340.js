...
const GioiThieu = () => {
    return (
        <div class="">
            <div
                ...
                <div className="flex gap-[50px]">
                    ...
                    <div className="pt-[180px] ">
                        <img 
                            className="h-[400px] w-[700px] rounded-[50px]] rounded-[20px] shadow-[0_40px_70px_-15px_rgba(0,0,0,0.8)]"
                            src = {Photo}
                            alt = "Photo1" 
                        />
                    </div>
            ...
            <div className="">
                <div className="font-montserrat font-bold tracking-wide text-[50px] subpixel-antialiased leading-[4.5rem] text-center">Về chúng tôi</div>
            </div>
        </div>
