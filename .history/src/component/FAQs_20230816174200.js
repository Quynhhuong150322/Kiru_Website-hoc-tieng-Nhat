        ...
        <div className="">
            ...
            <div className="pt-[250px] ">
                <div className="h-[200px] bg-yellow-500/40 items-center">
                    <div className="text-[32px] font-interBold">Hãy cùng Kiru chinh phục ngọn lửa trong bạn!</div>
                    <p className="text-[20px] font-interBold">Đăng ký để nhận ngay lộ trình học ngay hôm nay</p>
                    <div className="">
                    <button 
                        type="button"
