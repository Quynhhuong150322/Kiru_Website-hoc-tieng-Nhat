            ...
            <div className="">
                ...
                <div className="pl-[200px]">
                    <div className="grid grid-cols-2 gap-10 flex-initial w-[900px] pt-5">
                        <div className="">
                            <div className="">
                                <div className="h-[50px] w-[50px] bg-green-500 rounded-l-[20px] text-[40px] font-[600] cursor-pointer items-center text-center">
                                    <IoHomeOutline className="stroke-white"/>
                                </div>
