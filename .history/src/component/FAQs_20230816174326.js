        ...
        <div className="">
            ...
            <div className="pt-[250px] ">
                <div className="h-[200px] bg-yellow-500/40 items-center">
                    <div className="text-[32px] font-interBold text-center pt-10">Hãy cùng Kiru chinh phục ngọn lửa trong bạn!</div>
                    <p className="text-[15px] font-interBold text-center">Đăng ký để nhận ngay lộ trình học ngay hôm nay</p>
