    ...
    return (
        <div class="pl-[250px]">
            ...
            >
                ...
                <button 
                    type="button"
                    className = "w-[200px] h-10 rounded-[20px] text-white bg-gradient-to-r from-amber-300  to-orange-500 hover:border-2 border-amber-700 hover:text-sky-500 font-interBold text-[17px] items-center">
                    Tham gia ngay
                </button>
            </div>
        </div>
