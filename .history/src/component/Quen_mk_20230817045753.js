            ...
            <div className="h-[800px] flex justify-between pt-7">
                ...
                <div className=" pr-[100px] pt-10">
                    <div className="w-[650px] h-[400px] bg-amber-300 rounded-[20px]">
                        ...
                        <p className="pt-5 text-center font-inter text-[16px]">Nhập email hoặc số điện thoại của bạn để <p>nhận mã xác nhận để lấy lại mật khẩu.</p></p>
                        <div className="pl-[50px]">
                            <div className="font-bold pt-5 pb-2">Mail hoặc số điện thoại</div>
                            <div className="h-7 w-[540px] bg-white rounded-[10px] "></div>
                        </div>
                        <div className="pt-7 items-center pl-[220px]">
                            <button 
                                type="button"
