                ...
                <div className="pl-[200px]">
                    <div className="grid grid-cols-2 gap-10 flex-initial w-[900px] pt-5">
                        <div className="">
                            ...
                            <div className="font-inter text-[13px]">Kiru cung cấp cho bạn một hệ thống học với kiến thức tiếng Nhật đầy đủ và toàn diện như: Từ vựng, Ngữ pháp, Kanji,... và các bài kiểm tra sau mỗi bài học phong phú.</div>
                        </div>
                        <div className="">
                            <div className="">
