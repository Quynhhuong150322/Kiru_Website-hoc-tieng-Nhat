...
không giới hạn </p>
            ...
            <div 
                className="bg-[url('/Users/quynhhuong/kiru_web/src/image/photo3.jpeg')] bg-cover bg-center h-[450px] backdrop-brightness-50 blur-sm"
                alt = "photo3" >
                {/* <div className="w-full h-[450px] backdrop-brightness-50 blur-sm"></div> */}
