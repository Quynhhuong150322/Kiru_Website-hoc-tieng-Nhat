    ...
    return (
        <div class="">
            ...
            <div className="">
                ...
                <div className="pl-[200px] grid grid-cols-2">
...
không giới hạn </p>
                    ...
                    <div 
                        className="bg-[url('https://www.vietnambooking.com/wp-content/uploads/2019/09/5-ly-do-khuyen-ban-chon-du-lich-nhat-ban-mua-thu-16-9-2019-2.jpg')] bg-[length:750px_750px] h-[750px]"
                        // src = {Bg}
                        alt = "Bg" >
                    </div>
                </div>
