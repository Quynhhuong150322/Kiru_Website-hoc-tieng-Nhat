            ...
            <div className="pt-[50px] h-[900px] bg-amber-100 ">
                ...
                <div className="">
                    <div className="grid grid-cols-2 gap-10 gap-x-[100px] px-[150px] pt-[50px]">
                        <div className="h-[100px] px-2 py-2 bg-white rounded-[20px] shadow-[0_40px_70px_-15px_rgba(0,0,0,0.3)] flex gap-[30px] ">
                            <div classname="flex-initial w-[100px] items-center text-[20px]">
                                <p className="font-inter font-bold text-blue-500">500+</p>
                                <FaBookReader className="h-[50px] w-[50px]"/>
                            </div>
                            <div className="">
                                <div className="">Khóa học </div>
                                <p className="">Tổng hợp đầy đủ tất cả các kiến thức từ căn bản tới nâng cao và kinh nghiệm học thực tế.</p>
                            </div>
                        </div>
                        <div className="">
                            <div className="">Đề thi JLPT</div>
                            <p className="">Từ các bài kiểm tra tiếng Nhật kiến thức căn bản đến các bài thi năng lực theo chuẩn kỳ thi năng lực tiếng Nhật JLPT của Nhật.
</p>
                        </div>
                        <div className="">
                            <div className="">Ngữ pháp</div>
                            <p className="">Từ các bài kiểm tra tiếng Nhật kiến thức căn bản đến các bài thi năng lực theo chuẩn kỳ thi năng lực tiếng Nhật JLPT của Nhật.
</p>
                        </div>
                        <div className="">
                            <div className="">Từ vựng</div>
                            <p className="">Kho từ vựng đầy đủ và toàn diện, dễ dàng tìm kiếm theo chủ đề và tra cứu nhanh chóng, chính xác.
</p>
                        </div>
                    </div>
