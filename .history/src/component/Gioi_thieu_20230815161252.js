            ...
            <div className="pt-[50px] h-[900px] bg-amber-100 ">
                ...
                <div className="">
                    <div className="grid grid-cols-2 gap-10 gap-x-[100px] px-[150px] pt-[50px]">
                        <div className="h-[150px] px-5 py-5 bg-white rounded-[20px] shadow-[0_40px_70px_-15px_rgba(0,0,0,0.3)] flex gap-[30px] ">
                            <div classname="flex-initial w-[100px] items-center ">
                                <p className="font-inter font-bold text-blue-500 text-[20px]">500+</p>
