...
không giới hạn </p>
            ...
            <div 
                ...
                alt = "photo3" >
                <div className="backdrop-sepia-0 bg-white/90 h-[450px] ">
                    <div className="pl-[100px] w-[680px]">
                        <div className="pt-[100px] font-inter font-bold text-[36px] text-yellow-500">Bạn chưa biết <a class="text-[48px]">bắt đầu từ đâu</a> và phải học như thế nào?</div> 
                        <p className="">Kiru biết mỗi bạn sẽ có nhu cầu học theo trình độ khác nhau. Vì thế, tại Kiru đã xây dựng sẵn lộ trình học theo từng trình độ mà bạn lựa chọn. Mỗi lộ trình đều đi từ những kiến thức cơ bản  đến nâng cao với đầy đủ các kỹ năng cho bạn. </p>
                        <div className="pt-10">
                            <button 
                                type="button"
                                className = "w-[300px] h-[70px] rounded-[40px] text-white bg-gradient-to-r from-amber-300  to-orange-500 hover:border-2 border-amber-700 hover:text-sky-500 font-interBold text-[25px] items-center">
