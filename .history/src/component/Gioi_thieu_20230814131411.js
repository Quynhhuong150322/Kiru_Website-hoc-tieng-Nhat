...
không giới hạn </p>
            ...
            <div className="pt-[50px] h-[900px] bg-amber-100 ">
                ...
                <div className="">
                    <div className="grid grid-cols-2 gap-10 px-[100px] pt-[50px]">
                        <div className="h-[100px] px-1 py-1 bg-white rounded-[20px] shadow-[0_40px_70px_-15px_rgba(0,0,0,0.3)] grid grid-cols-2 ">
                            <div classname="flex-initial w-[800px]">
                                <FaBookReader/>
                            </div>
                            <div className="">
